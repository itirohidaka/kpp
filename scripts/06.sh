...
echo "Tarefa 06.02.01 - Configurando um dos membros do Cluster etcd"
...
echo "Tarefa 06.02.03 - Configurar o servidor etcd"
...
echo "Tarefa 06.02.04 - Inicializar o servidor etcd"
sudo systemctl daemon-reload
sudo systemctl enable etcd
sudo systemctl start etcd

echo "Fim da sessão 06"
